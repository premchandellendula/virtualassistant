...
def wishme():
   ...
   speak("Zune at your service. Please tell me how can i help you?")
...
def where_born():
    speak('I was created by a magician named Premchand, in Hyderabad, the Hub of Developmet.')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("I am Zune, The Smart Assistant of Premchand, Developed to help him around with his work and makes his life easier with his machine")
